...
public sealed class AppDbContextFactory : IDesignTimeDbContextFactory<AppDbContext>
{
    public AppDbContext CreateDbContext(string[] args)
    {
        ...
        if (string.IsNullOrWhiteSpace(connectionString))
            throw new InvalidOperationException(
                ...
                "Ensure it exists in appsettings.json (e.g. BookingTicket.Api/appsettings.json) or as an environment variable.");
    ...
    private static IConfigurationRoot BuildConfiguration()
    {
        ...
        AddIfFound(builder, currentDir, "BookingTicket.Api/appsettings.json");
        AddIfFound(builder, currentDir, $"BookingTicket.Api/appsettings.{env}.json");
